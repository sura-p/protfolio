                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                              ...
                              <Link class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" to={"/resume"}>Resume</Link>
                              <Link class="btn btn-outline-dark btn-lg px-5 py-3 fs-6 fw-bolder" to={"/projects"}>Projects</Link>
                                </div>
                            </div>
                        </div>
                        <div class="col-xxl-7">
